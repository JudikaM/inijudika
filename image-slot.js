...
(() => {
  ...
  const stylesheet =
    ...
    // Only suppress touch scrolling once reframe (pan/zoom) is active — a
    // static cover must let a finger-swipe scroll the page through it.
  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      // Only the author (omelette runtime) may upload. On a deployed share
      // link there's no writeFile bridge, so a visitor tapping an empty cover
      // must NOT get a file picker — let the click bubble to the card instead.
